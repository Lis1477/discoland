$(document).ready(function(){
	...
	var bl_width = wrapper_bl_width + item_margin; 

	// ДЛЯ БЛОКА ПОПУЛЯРНЫХ ТОВАРОВ *******************************************************************
	// количество популярных товаров всего
	var popular_item_count = $('.main-page_items-line.popular').data('item-count');
	// количество популярных товаров видимых
	var screen_count_popular; // количество итераций
	var popular_item_count_visible = (wrapper_bl_width + item_margin) / item_bl_width;
